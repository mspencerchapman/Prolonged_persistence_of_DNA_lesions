...
PVVs_with_properties_no_ctrl=get_hg19_properties(gpos=PVVs_GR)
PVVs_with_properties_df=as.data.frame(PVVs_with_properties)
PVVs_with_properties_no_ctrl_df=as.data.frame(PVVs_with_properties_no_ctrl)

metrics_df=get_quantile_metrics(df=PVVs_with_properties_df,
...
PVVs_signif_plot<-plot_quantile_metrics(df=PVVs_with_properties_df,
                                 metrics_to_plot = "signif",
                                 signif_levels = c(1e-3,1e-2,0.1))
...
ggsave("PVVs_all_metrics.pdf",plot = PVVs_plot,width=7,height=7)
ggsave("PVVs_signif_metrics.pdf",plot = PVVs_signif_plot,width=2,height=2.5)
